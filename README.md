...
| PATCH | `/assets/{id}/mark-in-repair` | ADMIN, MANAGER | Mark asset as IN_REPAIR |
| PATCH | `/assets/{id}/mark-repaired` | ADMIN, MANAGER | Return asset from repair to AVAILABLE |
...
| Method | Path | Access | Description |
|--------|------|--------|-------------|
| GET | `/alert-settings` | ADMIN, MANAGER | Retrieve current alert configuration |
| PUT | `/alert-settings` | ADMIN | Update alert configuration |
